    ...
    <div class="mui-inner-wrap">
        ...
        <div id="offCanvasContentScroll" class="mui-content  mui-scroll-wrapper">
            <div class="mui-content-padded">
                <!--卡片（）-->
                <div class="mui-card">
                    <div class="mui-card-header">当日医技
                        <span url="webyzcxyijixx/monthChartPage">
                            月医技
                        </span>
                    </div>
                    <div id="container" class="chart-box" style="width: 100%;height:300px;"></div>
                </div>
                <div class="mui-card">
                    <div class="mui-card-header">医技类型</div>
                    <div id="container1" class="chart-box" style="width: 100%;height:550px;"></div>
                </div>
            </div>
        </div>
        <!--侧滑栏出现后，主页面遮罩层-->
...
<script language="javascript" type="text/javascript" src="assets/yzcx/yiji/index.js"></script>
</body>
</html>