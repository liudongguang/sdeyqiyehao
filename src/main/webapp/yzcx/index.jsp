	...
	<div class="mui-inner-wrap">
		...
		<div id="offCanvasContentScroll" class="mui-content mui-scroll-wrapper">
			<div class="mui-content-padded">
				<!--卡片（门急诊）-->
				<div class="mui-card">
					<div class="mui-card-header">门诊急诊（今日） <span class="grayText">共<fmt:formatNumber type="number" value="${obj.mzsum+obj.jzsum}" pattern="0"
																									maxFractionDigits="0"/>人</span></div>
					<div class="mui-card-content">
						...
						<div class="mui-row totalBox">
							...
							<ul class="mui-col-sm-6 mui-col-xs-6">
								<li class="total-colorB" style="width: 92%; margin-right: 6%;">
									<p>医生平均门急诊量</p>
									<font><fmt:formatNumber type="number" value="${(obj.mzsum+obj.jzsum)*1.0/obj.ysgs}" pattern="0"
							...
							<ul class="mui-col-sm-6 mui-col-xs-6">
								<li class="total-colorD" style="width: 92%; margin-right: 6%;">
									<p>医生平均处方数量</p>
									<font><fmt:formatNumber type="number" value="${(obj.chufangshu)*1.0/obj.ysgs}" pattern="0"
						...
						<div class="mui-row" style="border-top:1px solid #ebebeb">
							<div class="mui-col-sm-12 mui-col-xs-12 bedUse-profile">处方总额：<fmt:formatNumber type="number" value="${obj.sumchufang}" pattern="0"
																										   maxFractionDigits="2"/>元</div>
						</div>
						<!--图表容器 处方金额-->
				...
				<!--卡片（在院人数）-->
				<div class="mui-card">
					<div class="mui-card-header">在院人数（今日）<span class="grayText">共<fmt:formatNumber type="number" value="${obj.zhuyuan.zaiyuanNum}"
																								   pattern="0"
																								   maxFractionDigits="0"/>人</span></div>
					<div class="mui-card-content">
						<!--总数模块区-->
							...
							<ul class="mui-col-sm-4 mui-col-xs-4">
								<li class="total-colorA" style="width: 92%; margin-left: 6%;">
									...
									<font><c:if test="${obj.zhuyuan.ruyuan!=null}">
										<fmt:formatNumber type="number" value="${obj.zhuyuan.ruyuan}" pattern="0"/></c:if>
							...
							<ul class="mui-col-sm-4 mui-col-xs-4">
								<li class="total-colorB">
									...
									<font><c:if test="${obj.zhuyuan.chuyuan!=null}">
										<fmt:formatNumber type="number" value="${obj.zhuyuan.chuyuan}" pattern="0"/></c:if>
							...
							<ul class="mui-col-sm-4 mui-col-xs-4">
								<li class="total-colorC" style="width: 92%; margin-right: 6%;">
									...
									<font><c:if test="${obj.zhuyuan.weizhong!=null}">
										<fmt:formatNumber type="number" value="${obj.zhuyuan.weizhong}" pattern="0"/></c:if>
							...
							<ul class="mui-col-sm-4 mui-col-xs-4">
								<li class="total-colorD" style="width: 92%; margin-left: 6%;">
									...
									<font><c:if test="${obj.zhuyuan.zhuanru!=null}">
										<fmt:formatNumber type="number" value="${obj.zhuyuan.zhuanru}" pattern="0"/></c:if>
							...
							<ul class="mui-col-sm-4 mui-col-xs-4">
								<li class="total-colorE">
									...
									<font><c:if test="${obj.zhuyuan.siwang!=null}">
										<fmt:formatNumber type="number" value="${obj.zhuyuan.siwang}" pattern="0"/></c:if>
						...
						<div class="mui-row" style="border-top:1px solid #ebebeb">
							<div class="mui-col-sm-12 mui-col-xs-12 bedUse-profile">床位使用率：<fmt:formatNumber type="number" value="${obj.zhuyuan.cwshiyonglv}"
																											pattern="0"
