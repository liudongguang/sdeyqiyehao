        ...
        <ul class="responsive">
            <li class="header-section"
                ...
                <div class="tit_sty">
                    ...
                    <span class="tit_sty_span2"><a href="webyzcxZyxx/zhuyuan_yue_page">查看月门诊量&nbsp;&gt;</a></span>
                    <span class="tit_sty_span2"><a href="webyzcxZyxx/index">&lt;查看日门诊量&nbsp;|</a></span>
                </div>
            </li>
...
<script type="text/javascript" language="javascript" src="assets/yzcx/zhuyuan/zhuyuan_year.js"></script>
</body>
</html>