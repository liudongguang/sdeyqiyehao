...
<div id="offCanvasWrapper" class="mui-off-canvas-wrap mui-draggable">
    <div class="mui-inner-wrap">
        ...
        <ul class="selectDate-box" style="margin-top: 44px;">
            ...
            <li>
            <li>
                <span url="webyzcxZyxx/index">日入院</span> | <span url="webyzcxZyxx/zhuyuan_yue_page">月入院</span>
            </li>
        </ul>
        <!------------页面内容容器------------>
        <div id="offCanvasContentScroll" class="mui-content mui-scroll-wrapper"
            ...
            <div class="mui-content-padded">
                ...
                <!--卡片容器-->
                <div class="mui-card">
                    <div class="mui-card-header">月入院人次</div>
                    <div class="mui-card-content">
                        <div id="year-ruyuanbar" class="chart-box" style="width: 100%;height:600px;"></div>
                    </div>
                </div>
                <div class="mui-card">
...
<script language="javascript" type="text/javascript" src="assets/yzcx/zhuyuan/year.js"></script>
</body>
</html>