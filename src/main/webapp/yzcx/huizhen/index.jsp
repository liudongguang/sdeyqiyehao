    ...
    <div class="mui-inner-wrap">
        ...
        <div id="offCanvasContentScroll" class="mui-content mui-scroll-wrapper">
            <div class="mui-content-padded">
                <div class="mui-card">
                    <div class="mui-card-header">当日会诊
                        <span url="webyzcxHuizhen/monthChartPage">
                            月会诊
                        </span>
                    </div>
                        ...
                        <div class="mui-row totalBox">
                            <ul class="mui-col-sm-6 mui-col-xs-6">
                                <li class="total-colorA" style="width: 92%; margin-left: 6%;">
                                    <p>会诊申请</p>
                                    <font><fmt:formatNumber type="number" value="${obj.shenqing}" pattern="0" maxFractionDigits="0"/></font>
                                </li>
                            </ul>
                            <ul class="mui-col-sm-6 mui-col-xs-6">
                                <li class="total-colorB" style="width: 92%; margin-right: 6%;">
                                    <p>会诊接受</p>
                                    <font><fmt:formatNumber type="number" value="${obj.jieshou}" pattern="0" maxFractionDigits="0"/></font>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="mui-card">
                    <div class="mui-card-header">科室会诊情况</div>
                    <div class="mui-card-content">
                        <div id="container" class="chart-box" style="width:100%;height:500px;"></div>
                    </div>
                </div>
...
<script language="javascript" type="text/javascript" src="assets/yzcx/huizhen/index.js"></script>
</body>
</html>