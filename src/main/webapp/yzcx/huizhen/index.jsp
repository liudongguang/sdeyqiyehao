...
<body>
<input type="hidden" value="9" id="navNum"/>
<div class="container">
                ...
                <div class="tit_sty_div_all">
                    <div class="tit_sty_div_all_tab2">
                        <div class="tit_sty_div_all_tab1_div1">
                            <p class="tit_sty_div_all_tab1_div1_p">会诊申请</p>
                            <p><fmt:formatNumber type="number" value="${obj.shenqing}" pattern="0" maxFractionDigits="0"/></p>
                        </div>
                    </div>
                    <div class="tit_sty_div_all_tab2">
                        <div class="tit_sty_div_all_tab1_div1">
                            <p class="tit_sty_div_all_tab1_div1_p">会诊接受</p>
                            <p><fmt:formatNumber type="number" value="${obj.jieshou}" pattern="0" maxFractionDigits="0"/></p>
                        </div>
                    </div>
                </div>
            </li>
...
<script type="text/javascript" language="javascript" src="assets/yzcx/huizhen/index.js"></script>
</body>
</html>