    ...
    <div class="mui-inner-wrap">
        ...
        <ul class="selectDate-box" style="margin-top: 44px;">
            <li data-options='{"type":"month","beginYear":2010,"endYear":2020}' class="btn">
                ...
                <span id="result"><fmt:formatDate value="${obj.start}" pattern="yyyy-MM"></fmt:formatDate></span>
            </li>
            <li>
                <span url="webyzcxHuizhen/index">日会诊</span>
            </li>
        </ul>
        <!------------页面内容容器------------>
        <div id="offCanvasContentScroll" class="mui-content mui-scroll-wrapper"
            ...
            <div class="mui-content-padded">
                <!--卡片容器-->
                <div class="mui-card">
                    <div class="mui-card-header">每日会诊</div>
                    <div class="mui-card-content">
                        <div id="container" class="chart-box" style="width: 100%;height:1000px;"></div>
                    </div>
                </div>
            </div>
        </div>
...
<script language="javascript" type="text/javascript" src="assets/yzcx/huizhen/month.js"></script>
</body>
</html>