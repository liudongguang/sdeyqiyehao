	...
	<div class="container-fluid">
		<div class="col-md-12" id="pajaxMainContainer" style="padding: 10px">
			<form method="post" id="subForm"
				action="${pageContext.request.contextPath }/messageboard/getLiuYanPingLunByID"
				class="form-inline" style="margin: 10px">
				<div class="form-group">
				<input type="hidden" value="${param.toptitle}" name="toptitle"/>
						...
						<tr>
							...
							<th scope="row">
								<button class="btn btn-outline-danger table_bt_cz" button-data
									del="del"
									href="${pageContext.request.contextPath }/messageboard/deletepinglunById?id=${obj.id}&messageid=${param.messageid}&title=${param.title}">
			...
			<input id="pageNum" type="hidden" value="${page.pageNum}" /> <input
				...
				type="hidden"
				value="messageboard/getLiuYanPingLunByID?messageid=${param.messageid}" />
			<input id="searFormID" type="hidden" value="subForm" /> <input
