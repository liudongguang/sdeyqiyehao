		...
		<ul class="responsive">
			<li class="header-section" style="background-color: white!important;margin-bottom: -43px!important;padding-bottom: 1px!important;">
				<div class="tit_sty" style="border: none!important;">
					...
					<span class="tit_sty_span2"><a href="yzcx/index.jsp"><&nbsp;查看日门诊量&nbsp;</a>||<a href="yzcx/indexnext.jsp">&nbsp;查看月门诊量&nbsp;></a></span>
					<!--<input type="text" class="input" id="monthly" placeholder="选择年份">-->
					<select name="" id="" style="border-radius: 3px">
			...
			<li class="body-section" style="padding-top: 0!important;">
				<div class="tit_sty">
