...
<body>
	...
	<nav class="breadcrumb">
		院长查询系统 <span class="c-gray en">&gt;</span> 角色权限<span class="c-gray en">&gt;</span>修改
	...
	<div class="pd-20" style="padding-top: 20px;">
		<p>
			<i class="Hui-iconfont"></i>修改用户
		</p>
	</div>
	<div class="pd-20">
		<form id="subFormID" action="yzcx/saveQXUser" method="post"
			class="form form-horizontal" id="form-user-character-add">
			<input name="userid" type="hidden" value="${qxuser.userid}" />
			<input id="qxids" type="hidden" value="${qxuser.qxids}" />
			<div class="row cl">
				<label class="form-label col-2"><span class="c-red">*</span>角色名称：</label>
				<div class="formControls">
					<span class="l mar_right"> <a href="javascript:;"
						class="btn btn-default radius"> ${qxuser.username}</a></span>
				</div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-10">
					<dl class="permission-list mar_bot">
						<dt>
							<label> <input type="checkbox" value="1" name="qxids"
								id="qxids"> 门诊信息
							</label>
						</dt>
					</dl>
					<dl class="permission-list mar_bot">
						<dt>
							<label> <input type="checkbox" value="2" name="qxids"
								id="user-Character-0-1"> 医院总收入
							</label>
						</dt>
					</dl>
					<dl class="permission-list mar_bot">
						<dt>
							<label> <input type="checkbox" value="3" name="qxids"
								id="user-Character-0-2"> 医技信息
							</label>
						</dt>
					</dl>
					<dl class="permission-list mar_bot">
						<dt>
							<label> <input type="checkbox" value="4" name="qxids"
								id="user-Character-0-3"> 医生出诊
							</label>
						</dt>
					</dl>
					<dl class="permission-list mar_bot">
						<dt>
							<label> <input type="checkbox" value="5" name="qxids"
								id="user-Character-0-4"> 手术安排
							</label>
						</dt>
					</dl>
					<dl class="permission-list mar_bot">
						<dt>
							<label> <input type="checkbox" value="6" name="qxids"
								id="user-Character-0-5"> 住院信息
							</label>
						</dt>
					</dl>
					<dl class="permission-list mar_bot">
						<dt>
							<label> <input type="checkbox" value="7" name="qxids"
								id="user-Character-0-6"> 护理单元
							</label>
						</dt>
					</dl>
					<dl class="permission-list mar_bot">
						<dt>
							<label> <input type="checkbox" value="8" name="qxids"
								id="user-Character-0-7"> 会诊信息
							</label>
						</dt>
					</dl>
				</div>
	...
	<script type="text/javascript"
		src="assets/yzcx/quanxian/js/update_admin_role.js"></script>
</body>
</html>