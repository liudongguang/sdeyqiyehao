...
<div class="container">
	...
	<nav class="slide">
		<ul>
			...
			<li><a href="yzcx/list4.jsp" class="active">医技信息</a></li>
		...
		<ul class="responsive">
			<li class="header-section" style="background-color: white!important;margin-bottom: -43px!important;padding-bottom: 65px!important;">
				<!--<div class="tit_sty">-->
					...
					<!--<span class="tit_sty_span2"><a href="yzcx/indexnext.jsp">查看月门诊量&nbsp;></a></span>-->
				<!--</div>-->
			...
			<li class="body-section" style="padding-top: 0!important;background-color: white">
				<!-- 为 ECharts 准备一个具备大小（宽高）的 DOM -->
				<div id="" style="width: 100%;height:200px;top: 10px!important;">
					<a href="#"><div class="tit_sty">
					<span class="tit_sty_span1">查看列表</span>
					<span class="tit_sty_span2"><img style="width: 20px;vertical-align: middle;" src="assets/yzcx/image/right.png" alt=""/></span>
					</div></a>
				</div>
			</li>
		</ul>
