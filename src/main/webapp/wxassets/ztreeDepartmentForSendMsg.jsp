...
<body>
	...
	<div>
		...
		<ul id="departmentTreeForSimpleData" class="ztree"
			style="width: 330px; overflow: auto;"></ul>
	</div>

	<div>
		<form id="subForm" action="wxassets/SendMsgToEmployee" method="post">
...
<script type="text/javascript" src="js/ztreeDepartmentForSendMsg.js"></script>
</html>