...
<div class="row">
    <div class="col-md-5">
        ...
        <form class="form-horizontal" id="subform" pajax-form method="post" action="permission_shiro/saveRoleAndPermission">
        ...
        <button class="btn btn-outline-primary waves-effect waves-light" id="subBT" type="submit"
                form="subform">
            保存
        </button>
