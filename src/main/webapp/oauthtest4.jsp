...
<link rel="stylesheet" href="${pageContext.request.contextPath }/assets/demo/style.css">
</head>
<body>
	...
	<input type="text" value="${sign.appId}" id="appId" />
	<input type="text" value="${sign.nonceStr}" id="nonceStr" />
	<input type="text" value="${sign.signature}" id="signature" />
	<input type="text" value="${sign.timestamp}" id="timestamp" />
</body>
...
<script src="${pageContext.request.contextPath }/js/demo.js">
