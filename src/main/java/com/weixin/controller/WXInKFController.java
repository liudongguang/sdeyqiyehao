...
import com.weixin.util.single.WXINKFBizMsgCryptSingleton;
...
@Controller
@RequestMapping(value = "/wxinkf")
public class WXInKFController {
	...
	private static String getSendTextJSon() throws JsonProcessingException {
		...
		ts.getSender().setId("cs"); // 发送人

		ts.getReceiver().setType("kf");
		ts.getReceiver().setId("a200731589"); // 接受者，客服
